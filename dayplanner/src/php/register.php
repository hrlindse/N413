...
//
    if(isset($_SESSION["user_id"])){
        ...
        $messages["token"] = $user_id;

    }else{        $messages["failed"] = '<h3 class="text-center">The Registration was not successful.</h3><div class="col-12 text-center"><a href="register.php" class="text-center"><button class="btn btn-primary mt-5">Try Again</button></a></div>';
    }
